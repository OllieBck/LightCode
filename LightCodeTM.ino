...
void startShow(int i) {
  switch (i) {
    case 0: colorWipe(pixel.Color(0, 0, 0), 50);    // Black/off
      break;
    case 1: colorWipe(pixel.Color(255, 0, 0), 50);  // Red
      break;
    case 2: colorWipe(pixel.Color(0, 255, 0), 50);  // Green
      break;
    case 3: colorWipe(pixel.Color(0, 0, 255), 50);  // Blue
      break;
    case 4: theaterChase(pixel.Color(127, 127, 127), 50); // White
      break;
    case 5: theaterChase(pixel.Color(127,   0,   0), 50); // Red
      break;
    case 6: theaterChase(pixel.Color(  0,   0, 127), 50); // Blue
      break;
    case 7: rainbow(20);
      break;
